                                            ...
                                            <tr class="section">
                                                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; line-height: 1.4; overflow: hidden; padding: 0 15px;" align="center">
                                                    <table class="img" style="border-collapse: collapse; width: 100%;" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                        <tr style="width: 100%;">
                                                            <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 15px; line-height: 1.4; color: #8c8c8c; font-weight: 300; margin: 0; padding: 14px 0;" align="center">${kcSanitize(msg("eventUpdatePasswordBodyHtml",event.date, event.ipAddress))?no_esc}
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="icon" style="display:flex; font-weight: bold;">
                                                                <a href="https://zenodo.org/communities/nfdi4plants?page=1&size=20" style="text-decoration:none; font-size:24; font-family: BlinkMacSystemFont, -apple-system, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue, Helvetica, Arial, sans-serif; color:white">
                                                                    Z
                                                                </a>
                                                            </span>
                                                        </td>
                                    ...
                                    <table class="img" style="border-collapse: collapse; width: 100%;" cellspacing="0" cellpadding="0" border="0">
                                        ...
                                        <tr style="width: 100%;">
                                            <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 15px; line-height: 1.4; color: #8c8c8c; font-weight: 300; margin: 0; padding: 14px 0;" align="center">
                                                This is an automatically generated email. Do not reply!. If you have any questions about your order, please contact via support.nfdi4plants.org
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
