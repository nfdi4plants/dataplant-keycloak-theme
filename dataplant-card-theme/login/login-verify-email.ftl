...
<#--                                                                value="${msg("doClickHere")}"-->
<#--                                                                onclick="window.location.href='${url.loginUrl}'" type="button">-->
                            ...
                            <div class="container m-4 is-white">
                                <div class="content has-text-justified">
                                    <h3 style="color:white; padding-top:1.9em">
                                        Verification Email was sent to you
                                    </h3>
                                    ...
                                    <p>
                                        Please verify your account by following the instructions in the email that was
                                        sent to you.
                                    </p>
                                    <p>
