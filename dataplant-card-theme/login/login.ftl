      ...
      <div class="columns">
        <div class="column align-items-top pb-5">
          ...
          <form onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
            ...
            <div class="container p-4">
              ...
              <div class="field">
                <input class="input is-rounded" placeholder="${msg("password")}" title="Department" formControlName="department" tabindex="2" name="password" type="password" autocomplete="off" aria-invalid="<#if messagesPerField.existsError('username','password')>true</#if>"
                    />
                    
                    <#if messagesPerField.existsError('username','password')>
                            <span class="help is-danger" class="${properties.kcInputErrorMessageClass!}" aria-live="polite">
                    ...
                    <#if realm.resetPasswordAllowed>
                      <div style="display:flex; justify-content:flex-end">
                        <span><a style="font-size:1.0em" href="${url.loginResetCredentialsUrl}">${msg("doForgotPassword")}</a></span>
                      </div>
                    </#if>
                ...
                <nav class="level">
                  ...
                  <div class="level-right">
                    <div class="level-item">
                      <button class="button is-rounded is-link is-fullwidth" style="padding-left: 2rem" value="${msg("doLogIn")}">
                        <span>Log in</span>
        ...
        <#if realm.password && social.providers??>
            ...
            -->
                ...
                <div class="${properties.kcFormSocialAccountListClass!} <#if social.providers?size gt 3>${properties.kcFormSocialAccountListGridClass!}</#if>" style="text-align:left">
                    <#list social.providers as p>
                        <button class="provider-button"  onclick="location.href='${p.loginUrl}'">
        ...
        <div style="height:10px"></div>
              ...
              <p>
               If you have linked your scientific account to DataPLANT, you can use it to login to all services seamlessly. 
               <!--
               <a href="${msg("registration_site")}" style="color:green">Link my account.​​</a>
               -->
              <p>
                Need an account?  <a href="${msg("registration_site")}" class="is-lightblue">SIGN UP​</a> 
              </p>
            </div>
          </div>
        </div>
