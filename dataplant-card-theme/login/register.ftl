                        ...
                        <div class="columns">
                            <div class="column align-items-top pb-5">
                                <div class="container box has-bg-white m-4 p-0">
                                    ...
                                    <progress title="1/3" class="progress myprogress" value="1" max="3">33%
                                    </progress>
                                </div>
                            </div>
...
<#--                                            </div>-->
<#--                                        </div>-->
<#--                                        <!--previous && next buttons&ndash;&gt;-->
<#--                                        <div class="field" style="margin-top: 2rem; margin-bottom: 1rem">-->
<#--                                            <nav class="level">-->
<#--                                                <!--button previous&ndash;&gt;-->
<#--                                                <div class="level-left">-->
<#--                                                    <div class="level-item">-->
<#--                                                        <button type="button"-->
<#--                                                                class="button is-rounded is-link is-fullwidth"-->
                        ...
                        <div class="columns">
                            <div class="column align-items-top pb-5">
                                <div class="container box has-bg-white m-4 p-0">
                                    ...
                                    <progress title="2/3" class="progress myprogress" value="2" max="3">66%
                                    </progress>
...
<#--                                        </div>-->
                                    ...
                                    <progress title="3/3" class="progress myprogress" value="3" max="3">100%
                                    </progress>
                                </div>
                            </div>
                            <!--text box-->
